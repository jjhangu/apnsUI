...
public class BatchApnsService extends AbstractApnsService {
    ...
    private static final Logger logger = LogManager.getLogger(BatchApnsService.class.getName());
			...
			try {
				...
				while ((msg = batch.poll()) != null) {
					try {
                        ...
                        UILogger.getInstance().add("Network exception sending message msg " + msg.getIdentifier() + e.toString());
                    }
				}
			} finally {
