...
public class ApnsPooledConnection implements ApnsConnection {
    private static final Logger logger = LogManager.getLogger(ApnsPooledConnection.class.getName());
    ...
    public void close() {
        ...
        try {
            ...
            UILogger.getInstance().add("pool termination interrupted" + e.toString());
        }
